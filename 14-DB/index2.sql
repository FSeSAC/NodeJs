...
/*
    ...
    having
    - 그룹에 대해 필터링(그래서 group by 와 함께 사용)
    - group by 뒤에 위치
    - 집계 함수랑 같이 사용 가능
