...
set SQL_SAFE_UPDATES = 1;	-- safe mode 재설정
...
update ordrers set customer_name='Jack Smith' where order_id=1;
select * from orders;
...
delete from orders 
where book_id in (SELECT book_id from books where author_id=3);
